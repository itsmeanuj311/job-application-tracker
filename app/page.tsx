...
import { ArrowRight, Briefcase, CheckCircle, CheckCircle2, TrendingUp } from "lucide-react";
          ...
          <div className="conntainer mx-auto px-4">
            <div className="grid gap-12 md:grid-cols-3">
              <div className=" flex flex-col">
                <div className="mb-4 inline-flex h-12 items-center justify-center rounded-lg bg-primary/10">
                ...
                <p className="text-muted-foreground">
                  ...
                  applications at every stage of your process.
                </p>
              </div>
              <div className=" flex flex-col">
                <div className="mb-4 inline-flex h-12 items-center justify-center rounded-lg bg-primary/10">
              ...
              <div className=" flex flex-col">
                ...
                <p className="text-muted-foreground">
                  Never Lose track of an application. Keep all of your job search
